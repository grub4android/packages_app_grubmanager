...
public class MountInfo {
    ...
    public MountInfo(int mountID, int parentID, int major, int minor, String root, String mountPoint, String mountOptions, String optionalFields, String separator, String fsType, String mountSource, String superOptions) {
        mMountID = mountID;
        mParentID = parentID;
        mMajor = major;
        mMinor = minor;
